var Chat = module.exports = {
  ...
  hasRoom: function(roomName) {
    var rooms = this.rooms.filter(function(element, index, array) {
  ...
  hasAttendant: function(attendants, user) {
    return attendants.some(function(element, index, array) { 
      return (element === user);
    });
  },
  leaveRoom: function(roomName, user) {
    ...
    rooms[0].attendants.forEach(function(element, index, array) {
      if (element === user) {
